...
const imagesToFind = [
    { src: "../assets/images/bluegem.png", top: '618px', left: '668px' },
    { src: "../assets/images/browngem.png", top: '480px', left: '605px' },
    { src: "../assets/images/lightgreengem.png", top: '430px', left: '626px' },
    ...
    { src: "../assets/images/whitegem.png", top: '680px', left: '1300px' },
